...
const file_mail_v1_config_proto_rawDesc = "" +
	...
	"\x04Mail\x123\n" +
	"\tproviders\x18\x01 \x03(\v2\x15.mail.v1.MailProviderR\tprovidersB\x8c\x01\n" +
	"\vcom.mail.v1B\vConfigProtoP\x01Z3github.com/byteflowing/go-common/gen/mail/v1;mailv1\xa2\x02\x03MXX\xaa\x02\aMail.V1\xca\x02\aMail\\V1\xe2\x02\x13Mail\\V1\\GPBMetadata\xea\x02\bMail::V1b\x06proto3"
